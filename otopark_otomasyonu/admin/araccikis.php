    ...
    if($db -> query("UPDATE arac_kayit SET arac_cikis_tarih = '$cikis_tarih'  WHERE arac_id=".$_GET['id']));{
        ...
        <table class="table">
            <tr>
                ...
                <td> <b style="color:red;">ARAÇ GİRİŞ TARİHİ</b> <b>=> <?php  $sonuc['arac_giris_tarih'] ?> </b> 
                <input type="text" name="arac_cikis_tarih" class="form-control" value="<?php   echo date('d-m-Y H:i:s')?>"></td>
            </tr>
