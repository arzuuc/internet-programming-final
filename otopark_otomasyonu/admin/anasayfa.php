 ...
 <div class="card p-2">
    ...
    if (isset($_POST['kaydet'])) {
       ...
       header ('Refresh:2; anasayfa.php');
                    ...
                    arac_blok = ?
                    ");
                    $kayit = $kaydet -> execute([$arac_plaka , $arac_kat , $arac_blok ]);
                    if ($kayit) {
                        echo '<div class="alert alert-primary text-center" role="alert">
                <strong> ARAÇ KAYIT EDİLDİ </strong>
                </div>';
     ...
     <div class="form">
       <h1 class="text-center mb-3">ARAÇ KAYIT</h1>
        <form action="anasayfa.php" method="post">
            <input type="text" name="arac_plaka" class="form-control text-center" placeholder="PLAKA GİRİNİZ" style="color:red;" ><br>
