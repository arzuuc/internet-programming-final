...
<div style="witdh:75px; margin-top:20px;" class="container">
<?php  
    ...
    <form action="" method="post">
      ...
      elseif($plaka<>"" && $kat<>"" && $blok<>""){
            if($db -> query("UPDATE arac_kayit SET arac_plaka = '$plaka' , arac_kat = '$kat', arac_blok ='$blok' WHERE arac_id=".$_GET['id']));{
                ...
                <strong> İŞLEM BAŞARILI ANASAYFAYA DÖNÜYORSUNUZ</strong>
                </div>';
                header ('Refresh:2; parkedenarac.php');
        ...
        <table class="table">
            <tr>
                ...
                <td> <b style="color:red;">ARAÇ PLAKA</b><b>=> <?php  echo $sonuc['arac_plaka'] ?> </b> 
                <input type="text" name="arac_plaka" class="form-control"value="<?php echo $sonuc['arac_plaka'] ?>"></td>
            </tr>
            <tr>
                <td>
                    <b> <b style="color:red";>ŞUAN BULUNDUĞU KAT</b>=> <?php echo $sonuc['arac_kat'] ?> </b>
                    <div class="mb-3">
                    <select name="arac_kat"class="form-control text-center mb-3" style="font-weight:bold;font-size22px;"><br>
            ...
            <tr>
                <td>
                    <b> <b style="color:red";>ŞUAN BULUNDUĞU BLOK</b>=> <?php  echo $sonuc['arac_blok'] ?> </b>
                    <div class="mb-3">
                    <select name="arac_blok"class="form-control text-center mb-3" style="font-weight:bold;font-size22px;"><br>
